...
This Functional Design Document (TDD) defines the **Quoting & Invoicing** capabilities for the HVAC, Plumbing, and Electrical services platform described in `functional.md`. It is intended to be detailed enough for engineers and LLM-based task generators to break the module into concrete implementation tasks.
